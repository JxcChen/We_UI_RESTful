...
try:
    ...
    # ======================    case_name:用例名称  =========================
    host = "https://cms-test.ienjoys.com/#/"
...
class Test(unittest.TestCase):
    default = web_start.App().start()

    @classmethod
    def tearDownClass(cls):
        cls.default.driver.quit()

    def setUp(self):
        self.default.get_index_page(host)
    ...
    def tearDown(self, method_name='None'):
        ...
        self.default.get_screenshot(picture_name)

    @util_retry_case(setUp, tearDown, retry_num)
    def test_01(self):
        '这里是用例描述'
        self.default.login('123124','1231231241')
        time.sleep(10)
